...
def run(param1, param2, param3):
    ...
    integral = 0.0
    for i in range(N):
        derivative = myrobot.y-prevY
        integral += myrobot.y
        prevY = myrobot.y
        angle = -param1*myrobot.y-param2*derivative-param3*integral
        myrobot = myrobot.move(angle, speed)
        print myrobot, angle 



run(0.0, 3.0, 0.004) # call function with parameter tau of 0.1 and print results
